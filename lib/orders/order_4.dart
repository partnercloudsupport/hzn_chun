...
class OrderFourPage extends StatefulWidget{


  var state;

  OrderFourPage(this.state);

  @override
  State<StatefulWidget> createState() {
    return new OrderFourWidget(state);
  }

}


class OrderFourWidget extends State<OrderFourPage>{

  var state;
  var pageNum = 0;

  OrderFourWidget(this.state);
